  ...
  return (
    <div className={`min-h-screen font-ui relative pb-20 transition-colors duration-300 ${
      ...
      <div className="fixed top-2.5 sm:top-3 left-0 right-0 z-50 px-2 sm:px-4 pointer-events-none">
        <header className={`pointer-events-auto max-w-5xl lg:max-w-6xl mx-auto h-14 sm:h-16 backdrop-blur-2xl border rounded-full shadow-2xl flex items-center justify-between px-3 sm:px-6 transition-all ${
