        ...
        try:
            ...
            if query_class == "greeting" and not matched_entities:
                ...
                system_prompt = (
                    ...
                    "2. STRUCTURED MARKDOWN TABLES: Format multi-item lists (such as bus routes, stop timings, course intakes, or eligibility criteria) as standard Markdown Tables (| Column 1 | Column 2 |).\n"
